...
# ══════════════════════════════════════════════
# Snapshot 协议单元测试（Phase 3.2 起已迁出至 tests/unit/test_baseline.py）
# ══════════════════════════════════════════════


def _run_snapshot_unit_tests() -> bool:
    """兼容层：转调 pytest（Phase 3.2 起的测试已在 sge/tests/unit/test_baseline.py）。"""
    import subprocess
    import sys
    result = subprocess.run(
        [sys.executable, '-m', 'pytest',
         'tests/unit/test_baseline.py', '-v', '--tb=short'],
...
if __name__ == "__main__":
    import sys
    sys.exit(0 if _run_snapshot_unit_tests() else 1)
