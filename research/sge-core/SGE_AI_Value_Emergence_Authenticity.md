...
**哲学立场说明**：金观涛认为”主体不是客观对象，而是一切对象化的前提”——这是一个先验论立场，意味着主体不能被当作研究和构建的对象。SGE 项目更认同涌现主义或功能主义——主体可以从足够复杂的功能系统中涌现。这一哲学分野是 SGE 实验的基础：SGE 的实验本质上就是在用工程方法检验这两种立场哪一个更接近真实。SGE 不声称金观涛是”错的”，而是选择站在涌现主义/功能主义的立场上设计可证伪的实验。  
